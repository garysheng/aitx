...
export const SCRIPT: Beat[] = [
  ...
  { line: "Michael and Jake don't call me anymore. They talk to their agent. Write NVIDIA a thank-you. Done, in their voice.", seconds: 11 },
  { line: "Warm, human, never corporate. They record it in their own voice and send it as a card. Gratitude at the speed of software.", seconds: 11 },
