...
LOGO_MIXING = [
    "logo lockup", "logo-lockup", "lockup of", "both logos", "two logos",
    "combine the logos", "combined logo", "partner's logo", "partner logo",
    "nvidia logo", "nvidia's logo", "nvidia eye", "co-branded logo",
    "logos side by side", "logos side-by-side", "merge the logos",
]
